...
<div class="container text-center text-md-start">
  <div class="row text-center text-md-start">
    <div class="row text-center text-md-start">
      <div class="col-lg-3 col-lg-3 mx-auto mt-3">
        ...
        <div class=iconos>
          ...
          <a href=""><iconify-icon icon="logos:whatsapp-icon"></iconify-icon></a>
...
<a href="" class="icono1"><iconify-icon icon="logos:visa"  width="50" style="padding-bottom: 7px; padding-right: 25px;"></iconify-icon></a>
    ...
    <a href="" class="icono1"><iconify-icon icon="cib:american-express" width="35" ></iconify-icon></a>
</div>
